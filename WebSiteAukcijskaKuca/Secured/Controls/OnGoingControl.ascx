<%@ Control Language="C#" AutoEventWireup="true" CodeFile="OnGoingControl.ascx.cs" Inherits="Secured_OnGoingControl" %>



    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ConnectionString="<%$ ConnectionStrings:MyLocalSqlServer %>" 
        SelectCommand="OfferedPrices_GetByUserId" SelectCommandType="StoredProcedure" >
        <SelectParameters>
...
<asp:SqlDataSource ID="SqlDataSource20" runat="server" 
    ConnectionString="<%$ ConnectionStrings:MyLocalSqlServer %>" 
    SelectCommand="OfferedPrices_GetByUserId_0" SelectCommandType="StoredProcedure">
    <SelectParameters>
        <asp:CookieParameter CookieName="UserId" Name="UserId" />
...
<asp:SqlDataSource ID="SqlDataSource21" runat="server" 
    ConnectionString="<%$ ConnectionStrings:MyLocalSqlServer %>" 
    SelectCommand="OfferedPrices_GetByUserId_1" SelectCommandType="StoredProcedure">
    <SelectParameters>
        <asp:CookieParameter CookieName="UserId"  Name="UserId" />
        <asp:Parameter DefaultValue="0" Name="minPrice" Type="Double" />
...
<asp:SqlDataSource ID="SqlDataSource22" runat="server" 
    ConnectionString="<%$ ConnectionStrings:MyLocalSqlServer %>" 
    SelectCommand="OfferedPrices_GetByUserId_2" SelectCommandType="StoredProcedure">
    <SelectParameters>
        <asp:CookieParameter CookieName="UserId"  Name="UserId" />
        <asp:Parameter DefaultValue="0" Name="minPrice" Type="Double" />
...
<asp:SqlDataSource ID="SqlDataSource23" runat="server" 
    ConnectionString="<%$ ConnectionStrings:MyLocalSqlServer %>" 
    SelectCommand="OfferedPrices_GetByUserId_3" SelectCommandType="StoredProcedure">
    <SelectParameters>
        <asp:CookieParameter CookieName="UserId" Name="UserId" />
        <asp:Parameter DefaultValue="0" Name="minPrice" Type="Double" />
...
<asp:SqlDataSource ID="SqlDataSource24" runat="server" 
    ConnectionString="<%$ ConnectionStrings:MyLocalSqlServer %>" 
    SelectCommand="OfferedPrices_GetByUserId_4" SelectCommandType="StoredProcedure">
    <SelectParameters>
        <asp:CookieParameter CookieName="UserId" Name="UserId"  />
        <asp:Parameter DefaultValue="0" Name="minPrice" Type="Double" />
        <asp:Parameter Name="maxTime" Type="DateTime" />
...
<asp:SqlDataSource ID="SqlDataSource25" runat="server" 
    ConnectionString="<%$ ConnectionStrings:MyLocalSqlServer %>" 
    SelectCommand="OfferedPrices_GetByUserId_5" SelectCommandType="StoredProcedure">
    <SelectParameters>
        <asp:CookieParameter CookieName="UserId" Name="UserId" />
        <asp:Parameter DefaultValue="0" Name="minPrice" Type="Double" />
        <asp:Parameter Name="minTime" Type="DateTime" />
...
<asp:SqlDataSource ID="SqlDataSource26" runat="server" 
    ConnectionString="<%$ ConnectionStrings:MyLocalSqlServer %>" 
    SelectCommand="OfferedPrices_GetByUserId_6" SelectCommandType="StoredProcedure">
    <SelectParameters>
        <asp:CookieParameter CookieName="UserId" Name="UserId" />
        <asp:Parameter DefaultValue="0" Name="minPrice" Type="Double" />
        <asp:Parameter Name="maxTime" Type="DateTime" />
...
<asp:SqlDataSource ID="SqlDataSource27" runat="server" 
    ConnectionString="<%$ ConnectionStrings:MyLocalSqlServer %>" 
    SelectCommand="OfferedPrices_GetByUserId_7" SelectCommandType="StoredProcedure">
    <SelectParameters>
        <asp:CookieParameter CookieName="UserId" Name="UserId" />
        <asp:Parameter DefaultValue="0" Name="minPrice" Type="Double" />
        <asp:Parameter Name="maxTime" Type="DateTime" />
...
<asp:Label ID="lblMessage" runat="server" Text="Label" class="messageFilter" style="margin-right: 117px;"></asp:Label>
    <div class="divTableRequests">
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
            ...
            ForeColor="#3366CC" 
            GridLines="None" ShowFooter="True" BorderStyle="None"  EmptyDataText="Till now no bidding have you done." ShowHeaderWhenEmpty="true">
