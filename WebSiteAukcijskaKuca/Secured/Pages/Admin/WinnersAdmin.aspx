<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="WinnersAdmin.aspx.cs" Inherits="Secured_Pages_WinnersAdmin" %>

<%@ Register src="../../Controls/WinnersControl.ascx" tagname="WinnersControl" tagprefix="uc1" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" Runat="Server">
    <uc1:WinnersControl ID="WinnersControl1" runat="server" />
</asp:Content>
