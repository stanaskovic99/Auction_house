<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ArticlesPerAuctionAdmin.aspx.cs" Inherits="Secured_Pages_ArticlesPerAuctionAdmin" %>

<%@ Register src="../../Controls/ArticlePerAuctionControl.ascx" tagname="ArticlePerAuctionControl" tagprefix="uc1" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" Runat="Server">
    <uc1:ArticlePerAuctionControl ID="ArticlePerAuctionControl1" runat="server" />
</asp:Content>
