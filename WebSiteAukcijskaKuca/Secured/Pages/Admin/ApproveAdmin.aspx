<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ApproveAdmin.aspx.cs" Inherits="Secured_Pages_CreateAdmin" %>

<%@ Register src="../../Controls/ApproveRegistrationControl.ascx" tagname="ApproveRegistrationControl" tagprefix="uc2" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <uc2:ApproveRegistrationControl ID="ApproveRegistrationControl1" 
        runat="server" />
