<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ArticlesAdmin.aspx.cs" Inherits="Secured_Pages_ArticlesAdmin" %>

<%@ Register src="../../Controls/ArticleControl.ascx" tagname="ArticleControl" tagprefix="uc1" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" Runat="Server">
    <uc1:ArticleControl ID="ArticleControl1" runat="server" />
</asp:Content>
