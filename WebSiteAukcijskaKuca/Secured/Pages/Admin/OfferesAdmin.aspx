<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="OfferesAdmin.aspx.cs" Inherits="Secured_Pages_OfferesAdmin" %>

<%@ Register src="../../Controls/OfferesControl.ascx" tagname="OfferesControl" tagprefix="uc1" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" Runat="Server">
    <uc1:OfferesControl ID="OfferesControl1" runat="server" />
</asp:Content>
